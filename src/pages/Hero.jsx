...
const Hero = () => {
  ...
  return (
    <>
      ...
      {/* Main Container */}
      <div className="w-full bg-[#FFF5F7] dark:bg-[#0f0f0f] transition-colors duration-300 relative overflow-hidden font-sans selection:bg-pink-200 selection:text-pink-900">
        ...
        <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between px-6 pt-20 pb-12 md:pt-28 md:pb-16 gap-12 md:gap-8 relative z-10">
          
          
          {/* TEXT SECTION */}
          <div className="flex flex-col justify-center w-full md:w-1/2 text-center md:text-left z-20 relative">
            
            <div className="space-y-6 relative z-10">
              
              {/* Tagline */}
              <div className="flex items-center justify-center md:justify-start gap-3 opacity-0 animate-fade-in-up" style={{ animationDelay: '100ms' }}>
              ...
              {/* Paragraph */}
              <p className="text-gray-600 dark:text-gray-400 text-base sm:text-lg max-w-md mx-auto md:mx-0 leading-relaxed font-light opacity-0 animate-fade-in-up" style={{ animationDelay: '300ms' }}>
                Discover the art of gifting with our hand-picked floral arrangements. Curated for elegance, delivered with love & care.
              </p>
            </div>
            
            {/* Buttons */}
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start pt-8 relative z-10 opacity-0 animate-fade-in-up" style={{ animationDelay: '400ms' }}>
            ...
            {/* Stats */}
            <div className="flex items-center justify-center md:justify-start gap-8 pt-10 relative z-10 opacity-0 animate-fade-in-up" style={{ animationDelay: '500ms' }}>
               <div>
          ...
          <div className="w-full md:w-1/2 flex justify-center md:justify-end relative opacity-0 animate-zoom-in" style={{ animationDelay: '400ms' }}>
            
            {/* Background Rings */}
            <div className="absolute top-1/2 left-1/2 md:left-auto md:right-[190px] -translate-x-1/2 md:translate-x-1/2 -translate-y-1/2 w-[450px] h-[450px] z-0 hidden sm:block pointer-events-none">
            ...
            <div className="relative w-full max-w-sm aspect-[3/4] group z-10">
              ...
              <div className="absolute -inset-3 border border-white/40 rounded-2xl z-0 hidden md:block backdrop-blur-[2px]"></div>
